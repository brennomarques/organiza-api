 ...
 */
class Contract extends \organiza\V1\Entity\Contract implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'organiza\\V1\\Entity\\Contract' . "\0" . 'id', '' . "\0" . 'organiza\\V1\\Entity\\Contract' . "\0" . 'files', '' . "\0" . 'organiza\\V1\\Entity\\Contract' . "\0" . 'size', '' . "\0" . 'organiza\\V1\\Entity\\Contract' . "\0" . 'status', '' . "\0" . 'organiza\\V1\\Entity\\Contract' . "\0" . 'dtResgister', '' . "\0" . 'organiza\\V1\\Entity\\Contract' . "\0" . 'cnpj'];
        }
